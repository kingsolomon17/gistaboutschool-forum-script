...
echo '<meta name="keywords" content="school news, waec, University, neco, Nabteb, Nigeria news, Nysc, Polytechnic, school of nursing, jamb">';
...
Forum"><img src="'.$config->url.'content/christmas-logo.png " width="305px" height="40px" /></h1></a>'.$out.'<b>Stats: </b>'.$totalmembers.' members,
...
name="localsearch" value="Local Search"></form></tbody></table><p><h2></h2>';
